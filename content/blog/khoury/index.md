...
that complain about the way that Java is _taught_ in CS 2510, because it's not
the way that Java is _used_ in industry.
...
2800, and 3500. If the course offerings on satellite campuses don't sufficiently
prepare students to take higher level courses in Boston, those are the courses
that should be updated to be more rigorous. As
...
in place for students to get the best education possible. This will directly be
counter to the College's interests by creating worse graduates, diminishing its
reputation to employers and making it harder to serve its main mission.

## My Personal Experience

> For a more factual summary of proposed changes, see
...
how bad the code I've written was. If I was allowed to skip the proposed CS0
because of my AP credit, and take CS1 purely in Python, I don't think I would be
anywhere close to where I am now - both ih terms of programming ability and in
terms of knowing what I want to do with my life.
...
the blurry line between what's covered here or in OOD. It also covers some data
structures and algorithms, which feels like it should belong in a class more
like CS 3000.
...
Rocq Reading Group that ran this semester. I hoped it would cover proof
assistants more, but I also understand the reasons that it doesn't.
...
of Four's book, but in Java instead of in C++. I previously wrote a
[post](/blog/gang-of-four) directly inspired by my experience taking this course
...
> able to taken), so use the appropriate amount of salt for this segment.
...
very much lauded as the better alternative to CS 4530, and offers a much more
